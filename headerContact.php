    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="" href="demande">Demandes</a></li>
          <li><a class="" href="membre">Equipe technique</a></li>
          <li><a class="" href="news">News</a></li>
          <!-- <li><a class="" href="/portfolio">Portfolio</a></li> -->
          <!-- <li><a class="" href="/equipe">Equipe</a></li> -->
          <li><a class="active" href="contact">Contacts</a></li>
          <li><a class="" href="login" style="color: green;"><strong>Login</strong></a></li>
        </ul>
      </nav><!-- .navbar -->
