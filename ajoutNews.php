	...
	if(isset($_POST['valider'])) 
		{ 
			...
			if (!empty($_POST['titreNews']) and !empty($_POST['imageNews']) and !empty($_POST['annonceNews'])) 
				{
					$req = $acces->prepare("INSERT INTO `news`(`titreNews`, `imageNews`, `annonce`) VALUES(:titreNews, :imageNews, :annonceNews)");
...
<div class="row">
  ...
  <div class="col-lg-12">
    <form action="" method="post" role="form" class="php-email-form">
        <div class="card-header"><h5><strong>Ajout de nouvelles annonces</strong></h5></div><br>
          <div class="row">
            <div class="col-md-6 form-group">
              <input type="text" name="titreNews" class="form-control" id="" placeholder="Titre de l'annonce" required autofocus>
            </div>
            <div class="col-md-6 form-group mt-3 mt-md-0">
              <input type="file" class="form-control" name="imageNews" id="" placeholder="Choisir l'image" required>
            </div>
          </div>
          <div class="form-group mt-3">
            <textarea class="form-control" name="annonceNews" rows="5" placeholder="Annonces" required></textarea>
          </div><br>
          <!-- <div class="my-3">
